am4core.ready(function () {
  ...
  am4core.ready(function () {
    ...
    var confirmedSeries = addSeries("Confirmados", confirmedColor);
    var recoveredSeries = addSeries("Recuperados", recoveredColor);
    var deathsSeries = addSeries("Mortes", deathsColor);
